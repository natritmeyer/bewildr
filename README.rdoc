...
for an overview of my adventures). White proved to be buggy, painful and worst of all, slow.
...
had a simple architecture (trying to figure out what's going in in white is not fun) and
